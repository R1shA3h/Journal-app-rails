...
ActiveRecord::Schema[7.2].define(version: 2024_10_13_155833) do
  ...
  create_table "shared_notes", force: :cascade do |t|
    ...
    t.index ["shared_by_id"], name: "index_shared_notes_on_shared_by_id"
  ...
  add_foreign_key "shared_notes", "users", column: "shared_by_id"
end
